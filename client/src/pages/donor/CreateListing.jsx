...
const CreateListing = () => {
  ...
  const categories = ["Cooked Meal", "Bakery", "Fruits & Vegetables", "Dairy", "Beverages", "Packaged Food", "Other"];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between">
        ...
        <Link to="/donor/dashboard" className="text-sm text-gray-500 hover:text-gray-800">
          ← Back to Dashboard
        </Link>
      </nav>

      <div className="max-w-2xl mx-auto px-4 py-10">
        <h1 className="text-2xl font-bold text-gray-900 mb-1">Post Food Listing</h1>
        <p className="text-gray-500 text-sm mb-8">Fill in the details about the food you want to donate</p>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-5">
          <div>
            ...
            <input
              type="text" name="title" placeholder="e.g. Leftover Rice and Curry"
          ...
          <div>
            ...
            <textarea
              name="description" placeholder="Describe the food, portion size, any allergens..."
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text" name="quantity" placeholder="e.g. 20 portions"
            ...
            <div>
              ...
              <select
                name="food_category" value={formData.food_category} onChange={handleChange} required
                className="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-green-500"
              >
          ...
          <div>
            ...
            <input
              type="text" name="city" placeholder="e.g. Colombo"
          ...
          <div>
            ...
            <input
              type="text" name="pickup_address" placeholder="Full pickup address"
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <p className="text-xs text-gray-500 font-medium mb-1">⚠️ Food Safety Responsibility</p>
            <p className="text-xs text-gray-400">
              By submitting this listing, you confirm that the food is safe for consumption and has been stored properly. The system will automatically calculate a safety score based on preparation and expiry times.
            </p>
          </div>
